...
public class SpDetailsDto {
	private String SP_Ref_No,TOCO_Site_Id="",Date_of_Proposal="",customerSiteId,CustomerSiteName,SiteType,
	Latitude,Longitude,TowerType,Project_Name,Power_Rating="",Site_Electrification_Distance="",
	Tentative_EB_Availibility="",Additional_Charge="",Address1="",Head_Load_Charge="",Electrification_Cost="",
	Electrification_Line_Distance="",Electricity_Connection_HT_LT="",Infra_Details="",Site_Classification="",
	Expected_Rent_to_Landlord="",Non_Refundable_Deposit="",Estimated_Deployment_Time__in_days_="",Additional_Capex="",
	Standard_Rates="",Fiber_Charges="",Rental_Threshold="",Excess_Rent_beyond_Threshold="",Tentative_Rental_Premium="",
	Additional_Rent="",IPFee="",Field_Operation_Charges="",Security_Guard_Charges="",Mobilization_Charges="",
	Erection_Charges="",battery_backup_Hrs="",Land_Lord_Charges_or_Rent_Charges="",Remarks="",City,Wind_Speed="",
	Preferred_Product_Type_by_Customer="",Recommended_Product_Type_by_Acquisition="";
	
	private Double TowerHeight,agl,Distance_from_P1_Lat_Long_in_meter;
	...
	public void setBattery_backup_Hrs(String battery_backup_Hrs) {
		this.battery_backup_Hrs = battery_backup_Hrs;
	}
	...
	public String getPreferred_Product_Type_by_Customer() {
		return Preferred_Product_Type_by_Customer;
	}

	public void setPreferred_Product_Type_by_Customer(String preferred_Product_Type_by_Customer) {
		Preferred_Product_Type_by_Customer = preferred_Product_Type_by_Customer;
	}
