...
public class SrRequestJsonDto {
	...
	public PriorityDetailsDto getPriority_Details() {
		return Priority_Details;
	}
	public void setPriority_Details(PriorityDetailsDto priority_Details) {
