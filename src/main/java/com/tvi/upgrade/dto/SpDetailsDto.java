...
public class SpDetailsDto {
	private String SP_Ref_No,TOCO_Site_Id,Date_of_Proposal,customerSiteId="",CustomerSiteName="",SiteType="",Latitude="",Longitude="",
	TowerType,Project_Name,Power_Rating="",Tentative_EB_Availibility="",Electricity_Connection_HT_LT="",Difficult="",
	Infra_Details="",Site_Classification="",Expected_Rent_to_Landlord="",Non_Refundable_Deposit="",
	...
	IPFee="",Field_Operation_Charges="",Security_Guard_Charges="",
	Mobilization_Charges="",Erection_Charges="",Land_Lord_Charges_or_Rent_Charges="",
	Distance_from_original_P1_Lat_Long_in_meter="",Remarks="",Rejection_Remarks="",Wind_Speed="",
	ProductType="";
	
	private Double Site_Electrification_Distance,Additional_Charge,Head_Load_Charge,
	Electrification_Line_Distance,TowerHeight,Electrification_Cost,agl,Distance_from_P1_Lat_Long_in_meter;
	...
	public String getDistance_from_original_P1_Lat_Long_in_meter() {
		return Distance_from_original_P1_Lat_Long_in_meter;
	}
	public void setDistance_from_original_P1_Lat_Long_in_meter(String distance_from_original_P1_Lat_Long_in_meter) {
		Distance_from_original_P1_Lat_Long_in_meter = distance_from_original_P1_Lat_Long_in_meter;
	}
	...
	public Double getSite_Electrification_Distance() {
		return Site_Electrification_Distance;
	}
	public void setSite_Electrification_Distance(Double site_Electrification_Distance) {
	...
	public Double getHead_Load_Charge() {
		return Head_Load_Charge;
	}
	public void setHead_Load_Charge(Double head_Load_Charge) {
		Head_Load_Charge = head_Load_Charge;
	}
	public Double getElectrification_Line_Distance() {
		return Electrification_Line_Distance;
	}
	public void setElectrification_Line_Distance(Double electrification_Line_Distance) {
	...
	public Double getElectrification_Cost() {
		return Electrification_Cost;
	}
	public void setElectrification_Cost(Double electrification_Cost) {
	...
	public Double getDistance_from_P1_Lat_Long_in_meter() {
		return Distance_from_P1_Lat_Long_in_meter;
	}
	public void setDistance_from_P1_Lat_Long_in_meter(Double distance_from_P1_Lat_Long_in_meter) {
