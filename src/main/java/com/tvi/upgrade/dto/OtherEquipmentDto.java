...
public class OtherEquipmentDto {
	...
	private String Feasibility,CustomerPunchedOrPlanning,Deletion_OR_Relocation;
	
	private String Action,Source_Request_RefNo,Other_Equipment_Category,Other_Equipment_Type,Equipment_to_be_relocated,
