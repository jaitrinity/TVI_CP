...
public class SpReceivedUpgradeDto {
	private SpDetailsDto SPDetails_RL;
...
//	private OtherEquipmentDto Other_Equipment;
	...
	public SpDetailsDto getSPDetails_RL() {
		return SPDetails_RL;
	}
	public void setSPDetails_RL(SpDetailsDto sPDetails_RL) {
		SPDetails_RL = sPDetails_RL;
	}
