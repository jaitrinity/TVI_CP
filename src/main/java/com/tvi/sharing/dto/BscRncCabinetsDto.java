...
public class BscRncCabinetsDto {
	...
	public Double getHeight_AGL() {
		return Height_AGL;
	}
	public void setHeight_AGL(Double height_AGL) {
		Height_AGL = height_AGL;
	}
	public Double getBSC_RNC_Power_Rating() {
		return BSC_RNC_Power_Rating;
	}
	public void setBSC_RNC_Power_Rating(Double bSC_RNC_Power_Rating) {
