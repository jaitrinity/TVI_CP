...
public class StrageticDto {
	private String Feasibility="No",Is_it_Strategic,Shelter_Size,DG_Redundancy,Extra_Battery_Bank_Requirement,Extra_Battery_BackUp,
	Anyother_Specific_Requirements;
	private Double Length_Mtrs,Breadth_Mtrs,Height_AGL_Mtrs;
	
	private String Extra_Battery_Back_Up,Any_other_specific_requirements="NA";
	...
	public Double getHeight_AGL_Mtrs() {
		return Height_AGL_Mtrs;
	}
	public void setHeight_AGL_Mtrs(Double height_AGL_Mtrs) {
		Height_AGL_Mtrs = height_AGL_Mtrs;
	}
	public String getAny_other_specific_requirements() {
		return Any_other_specific_requirements;
	}
	public void setAny_other_specific_requirements(String any_other_specific_requirements) {
		Any_other_specific_requirements = any_other_specific_requirements;
	}
	public String getExtra_Battery_Back_Up() {
		return Extra_Battery_Back_Up;
	}
	public void setExtra_Battery_Back_Up(String extra_Battery_Back_Up) {
		Extra_Battery_Back_Up = extra_Battery_Back_Up;
	}
