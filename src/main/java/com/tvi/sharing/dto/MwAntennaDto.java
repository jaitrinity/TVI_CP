...
public class MwAntennaDto {
	private String Feasibility,Customer_Punched_Or_Planning="Planning",Sector_Details="Sector 1";
	...
	public Double getSize_of_MW() {
		return Size_of_MW;
	}
	public void setSize_of_MW(Double size_of_MW) {
		Size_of_MW = size_of_MW;
	}
	public Double getHeight_in_Mtrs() {
		return Height_in_Mtrs;
	}
	public void setHeight_in_Mtrs(Double height_in_Mtrs) {
