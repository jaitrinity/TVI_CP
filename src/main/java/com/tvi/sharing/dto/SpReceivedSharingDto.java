...
public class SpReceivedSharingDto {
	private SpDetailsDto SPDetails_RES;
...
//	private OtherEquipmentDto Other_Equipment;
	...
	public SpDetailsDto getSPDetails_RES() {
		return SPDetails_RES;
	}
	public void setSPDetails_RES(SpDetailsDto sPDetails_RES) {
		SPDetails_RES = sPDetails_RES;
	}
